...
$homepage_post_sequence = get_homepage_new_article_cache( $today );

// 取得上一頁 label and link
...
#home-feature-articles .category-wrap .desktop-article-hr {
	display: none;
}

#home-feature-issue .issue-block:last-child .desktop-article-hr {
	display: none;
}
...
#home-feature-articles .hero-article .feature-image a:hover img,
#home-feature-articles .one-article .feature-image a:hover img,
#home-feature-articles .two-article .feature-image a:hover img, 
#home-feature-articles .three-article .feature-image a:hover img {
	opacity: .5;
}
...
#home-feature-articles .hero-article .title a:hover,
#home-feature-articles .one-article .title a:hover,
#home-feature-articles .two-article .title a:hover,
#home-feature-articles .three-article .title a:hover {
	color:gray;
}
...
<div class="row homepage-contaner">
	<div id="masthead-desktop" class="fixed">
		<div class="inner-wrap">
			...
			<h6><?php echo date("Y", $today); ?></h6>
			<h3><?php echo date('F d', $today); ?></h3>
			<h4><?php echo date("l", $today); ?></h4>
			<div class="hr"></div>
		</div>
	...
	<div id="home-feature-articles">
		...
		<div class="category-wrap clearfix">		
			...
			<?php if ( ! wp_is_mobile() ) : if ( get_option( 'fliper_homepage_ad_banner_link' ) && get_option( 'fliper_homepage_ad_banner_img' ) ) : ?>
			<div class="" style="margin:45px 15px;"><a target="_blank" style="display:block;" href="<?php echo get_option( 'fliper_homepage_ad_banner_link' ); ?>"><img style="width:800px;height:120px;display: block;" src="<?php echo get_option( 'fliper_homepage_ad_banner_img' ); ?>" /></a></div>
			<?php endif; else : if ( get_option( 'fliper_homepage_ad_banner_link' ) && get_option( 'fliper_homepage_ad_banner_img_mobile' ) ) : ?>
			<div class="" style="margin: 25px 20px;"><a target="_blank" style="display:block;" href="<?php echo get_option( 'fliper_homepage_ad_banner_link' ); ?>"><img style="width:300px;height:120px;display:block;" src="<?php echo get_option( 'fliper_homepage_ad_banner_img_mobile' ); ?>" /></a></div>
			<?php endif; endif; ?>
		...
		<?php $homepage_section_count += 1; else : ?>
			<?php if ( ! wp_is_mobile() ) : if ( get_option( 'fliper_homepage_ad_banner_link' ) && get_option( 'fliper_homepage_ad_banner_img' ) ) : ?>
			<div class="" style="margin:45px 15px;"><a target="_blank" style="display:block;" href="<?php echo get_option( 'fliper_homepage_ad_banner_link' ); ?>"><img style="width:800px;height:120px;display: block;" src="<?php echo get_option( 'fliper_homepage_ad_banner_img' ); ?>" /></a></div>
			<?php endif; else : if ( get_option( 'fliper_homepage_ad_banner_link' ) && get_option( 'fliper_homepage_ad_banner_img_mobile' ) ) : ?>
			<div class="" style="margin: 25px 20px;"><a target="_blank" style="display:block;" href="<?php echo get_option( 'fliper_homepage_ad_banner_link' ); ?>"><img style="width:300px;height:120px;display:block;" src="<?php echo get_option( 'fliper_homepage_ad_banner_img_mobile' ); ?>" /></a></div>
		...
		<?php $homepage_section_count += 1;wp_reset_query(); ?>
		...
		// 	'posts_per_page' => -1,
		// 	'no_found_rows' => true,
		// 	'category_name' => '22-online-design-exhibition'
		// ) );
	
		// if ( $query->have_posts() ) :
		?>
		<?php /* <!-- <div class="category-wrap clearfix">		
			<div class="category-header">
				<span class="category-count">04</span>
				<div class="category-name">
					<div class="zh">超狂作品，畢業生的逆襲</div>
				</div>
				<div class="category-hr"></div>
			</div>
			<?php if ( 1 === $query->post_count ) : $query->the_post(); ?>
		...
		<div class="paginator">
			<a class="old-page" href="<?php echo $yesterday_link; ?>">Yesterday<span class="arrow iconset"></span></a>
		</div>
