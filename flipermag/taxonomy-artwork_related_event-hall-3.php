...
<div class="page-container">
	...
	<div class="intro">
		<div>
			<h4 class="_desktop">天空、大海、以及那些與你的其他</h4>
			<div class="clearfix">
				...
				<h1>共生之島</h1>
				<h4 class="_mobile">天空、大海、以及那些與你的其他</h4>
			</div>
		</div>
		<div class="t2">「如果你馴服了我，我們就互相不可缺少了。 對我來說，你就是世界上唯一的了；我對你來說，也是世界上唯一的了。」<br/><br/>
			小王子告訴狐狸，馴服，就是一種建立關係。如果全世界只剩下自己，我們也許，不會這麼奮不顧身，正是因為所愛的人，以及愛我的人，我們才每天這樣努力著。共生之島中，漂浮了無數個為了更美好的世界的夢想。問題，需要被看見，被說出，才有辦法獲得重視，並解決。
		</div>
	</div>

	<div id="exhibition-hall" class="clearfix">
		<?php while( $query->have_posts() ) : $query->the_post(); ?>
		<a class="artwork defer-link" href="<?php the_permalink(); ?>?so=hall-3">
			<div class="cover">
	...
	<div class="progress-bar clearfix fixed">
		...
		<div class="t3 _desktop">03 共生之島</div>
...
jQuery(document).ready(function() {
	...
	jQuery('.back-button').click(function(){
		...
		window.location = '/the-void-of-22-4-showroom/#hall-3';
	});
