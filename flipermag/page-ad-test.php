...
<div class="full-article row">
	...
	<?php if ( wp_is_mobile() ) : ?>
	<!-- /28125781/article_page_bottom_scoll_bg -->
	<div id='div-gpt-ad-1601831787237-0'>
	  <script>
	    googletag.cmd.push(function() { googletag.display('div-gpt-ad-1601831787237-0'); });
	  </script>
	</div>
	<?php endif; ?>

	<!-- <div class="ad-test hide-on-desktop" style="">
		<!-- <ins class='dcmads clearfix' style='display:inline-block;width:300px;height:250px'
		    data-dcm-placement='N724080.1915638MOBKOI/B20253265.208949967'
		    data-dcm-rendering-mode='script'
		    data-dcm-https-only
		    data-dcm-param-offsettop=''
		    data-dcm-param-offsetbottom=''
	...
	<!-- <div class="ad-test hide-on-desktop" style="">
		<ins class='dcmads' style='display:inline-block;width:300px;min-height:250px;height:auto;'
		    data-dcm-placement='N724080.2760002ADGEEK/B24682090.283332539'
		    data-dcm-rendering-mode='script'
		    data-dcm-https-only
		    data-dcm-publisher-url='%%SITE%%'
		    data-dcm-param-disableautoplay='false' 
		    data-dcm-param-offsettop=''
		    data-dcm-param-offsetbottom=''  
	...
	<div class="author-wrap">
		<div class="author">
			<a class="avatar" href="<?php echo get_author_posts_url( get_the_author_id() ); ?>"><?php echo get_avatar( get_the_author_meta('email'), '300' ); ?></a>
