...
<div class="page-container">
	...
	<div class="intro">
		<div>
			...
			<div class="clearfix">
				...
				<h1>日記工廠</h1>
				<h4 class="_mobile">一首稍顯過長的詩</h4>
			</div>
		</div>
		<div class="t2">「 八月三十一日 ，天氣炎熱，心情尚可 」<br/><br/>
			在這裏，充滿著青春片刻中，那些暫留的呢喃。也許有意義，也許無意義，也許是肯定句，也許是沒有人可以回答的，對生命的嚴肅提問；也或是一些浪漫詩句，一些日子的碎屑。
		</div>
	</div>

	<div id="exhibition-hall" class="clearfix">
		<?php while( $query->have_posts() ) : $query->the_post(); ?>
		<a class="artwork defer-link" href="<?php the_permalink(); ?>?so=hall-4">
			<div class="cover">
	...
	<div class="progress-bar clearfix fixed">
		...
		<div class="t3 _desktop">04 日記工廠</div>
...
jQuery(document).ready(function() {
	...
	jQuery('.back-button').click(function(){
		...
		window.location = '/the-void-of-22-4-showroom/#hall-4';
	});
