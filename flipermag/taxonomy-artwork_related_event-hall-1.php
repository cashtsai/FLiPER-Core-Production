...
<div class="page-container">
	...
	<div class="intro">
		<div>
			...
			<div class="clearfix">
				...
				<h1>派對現場</h1>
				<h4 class="_mobile">在記憶失控以前</h4>
			</div>
		</div>
		<div class="t2">「5、4、3、2、1」<br/><br/>
			儀式，成為人類對自然的古老反抗 。也許日常終將把一切吞噬，但在那之前，我們仍會頑固抵抗，在記憶的無涯中、在遺忘以前。歡迎來到22歲的派對現場，這裡將會是一些關於儀式、關於時間、關於那些需要被記下的、被慶祝的、被哀悼的無數個記憶現場。
		</div>
	</div>
	...
	<div class="progress-bar clearfix fixed">
		...
		<div class="t3 _desktop">01 派對現場</div>
