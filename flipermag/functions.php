...
if ( function_exists( 'add_theme_support' ) ) {
	add_image_size( 'post-thumb', 900, 563, true );
	add_image_size( 'home-slider-2x', 552, 345, true );
	add_image_size( 'home-top-big-2x', 900, 563, true );
	add_image_size( 'home-top-small-2x', 490, 306, true );
	add_image_size( 'list-articles-thumb-2x', 720, 450, true );
...
function flipermag_wp_head() {
	...
	<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700&family=IBM+Plex+Mono:wght@400;500;600;700&family=Noto+Serif+TC:wght@300;400;500;600;700&display=swap" rel="stylesheet">
